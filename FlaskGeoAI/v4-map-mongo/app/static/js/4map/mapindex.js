mapboxgl.accessToken = 'pk.eyJ1Ijoic2FsaXRvMyouridpleases3_tURsg';
...
function WeatherSource() {
    fetch("https://api.openweathermap.org/data/2.5/weather?q=Hamburg&units=metric&appid=99youridpleaseab6").then((response) => response.json()).then((user) => {
