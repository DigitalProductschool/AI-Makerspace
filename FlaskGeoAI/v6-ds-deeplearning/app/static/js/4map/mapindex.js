...
function WeatherSource() {
    fetch("https://api.openweathermap.org/data/2.5/weather?q=Hamburg&units=metric&appid=99bwefweyouridhere6").then((response) => response.json()).then((user) => {
