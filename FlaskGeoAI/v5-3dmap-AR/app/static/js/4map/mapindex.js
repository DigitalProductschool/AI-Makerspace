...
function WeatherSource() {
    fetch("https://api.openweathermap.org/data/2.5/weather?q=Hamburg&units=metric&appid=99youridheree0beab6").then((response) => response.json()).then((user) => {
